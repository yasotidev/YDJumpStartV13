...
{
    // Pour plus d'informations sur ASP.NET Identity, consultez http://go.microsoft.com/fwlink/?LinkId=301863
    public static class IdentityConfig
    {
        ...
        public static void ConfigureIdentity()
        {
            ...
            // Définir le domaine de l'application
            Realm = ConfigurationManager.AppSettings["ida:realm"];

            // Définir audienceUri pour l'application
