...
namespace Yd.Admin.Web.Controllers
{
    public class PersonController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "PersonId,FirstName,LastName")] Person person)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "PersonId,FirstName,LastName")] Person person)
        {
            if (ModelState.IsValid)
            {
